...
Command: npx gltfjsx@6.1.4 public/model/avatar-3D.glb
*/
...
export function Model(props) {
  const group = useRef();
  const { nodes, materials, animations } = useGLTF("/model/avatar-dancing.glb");
  ...
  return (
    ...
    <group name="Scene">
      <group name="Armature">
        ...
        <skinnedMesh name="Wolf3D_Headwear" geometry={nodes.Wolf3D_Headwear.geometry} material={materials['Wolf3D_Headwear.001']} skeleton={nodes.Wolf3D_Headwear.skeleton} />
...
useGLTF.preload("/model/avatar-dancing.glb");
